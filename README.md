    ...
    <script>
        ...
        function getLifePathDescription(number) {
            const descriptions = {
                ...
                11: "Вы - просветленный, интуитивный и вдохновляющий. Ваша миссия - нести духовное озарение, вдохновлять других и служить высшим идеалам. Число 11 - это мастер-число, символизирующее духовное пробуждение и высшую интуицию.",
        ...
        function getLifePathStrengths(number) {
            const strengths = {
                ...
                11: "Интуиция, вдохновение, идеализм, визионерство, чувствительность, духовность, способность к трансформации, высшее сознание.",
        ...
        function getLifePathWeaknesses(number) {
            const weaknesses = {
                ...
                11: "Нервозность, мечтательность без действия, сверхчувствительность, непрактичность, склонность к иллюзиям, трудности с заземлением.",
        ...
        function getLifePathAdvice(number) {
            const advice = {
                ...
                11: "Заземляйте свои идеи, развивайте практические навыки, не пренебрегайте материальным миром. Учитесь балансировать между духовным и материальным.",
        ...
        function getPortraitDescription(number, type) {
            const descriptions = {
                'lifePath': {
                    ...
                    11: "Число Жизненного Пути 11 - это мастер-число, символизирующее духовное пробуждение и высшую интуицию. Вы - просветленный проводник, призванный вдохновлять других и нести духовные истины. Ваша миссия - служить мостом между материальным и духовным мирами."
                },
                'destiny': {
                    ...
                    11: "Число Судьбы 11 - это высшее духовное предназначение. Вы призваны быть проводником света и вдохновителем для многих. Ваша миссия - пробуждать духовное сознание в других и служить примером высших идеалов."
                },
                'soul': {
                    ...
                    11: "Число Души 11 отражает вашу глубинную потребность в духовном пробуждении и служении высшим идеалам. Вы жаждете трансцендентного опыта и возможности делиться духовными озарениями с другими."
                },
                'appearance': {
                    ...
                    11: "Число Внешнего Облика 11 создает впечатление одухотворенного, вдохновляющего и загадочного человека. Окружающие чувствуют вашу особую энергетику и видят в вас духовного наставника."
                },
                'birthday': {
                    ...
                    11: "Число Дня Рождения 11 наделяет вас врожденной духовной чувствительностью и интуицией. Вы рождены с особой миссией - быть проводником духовных истин и вдохновлять других на высшие идеалы."
                },
                'karmic': {
                    ...
                    11: "Число Кармического Долга 11 указывает на необходимость развивать духовную ответственность. В прошлых жизнях вы могли злоупотреблять духовной силой или не выполнить свое высшее предназначение, и теперь должны научиться использовать свои дары мудро и бескорыстно."
                }
            };
        ...
        function generatePortraitStrengths(lifePath, destiny) {
            const strengths = {
                ...
                11: "Высшая интуиция, духовная чувствительность, способность к вдохновению, визионерство, трансформационное влияние."
            };
        ...
        function generatePortraitWeaknesses(lifePath, karmic) {
            const weaknesses = {
                ...
                11: "Нервозность, склонность к иллюзиям, трудности с заземлением, чрезмерная чувствительность к энергетическим воздействиям."
            };
        ...
        function generatePortraitAdvice(lifePath, destiny, karmic) {
            const advice = {
                ...
                8: "Развивайте духовность, не ставьте материальные цели выше человеческих отношений, учитесь отдыхать.",
                9: "Будьте более практичными, учитесь говорить 'нет', не позволяйте другим использовать вашу доброту.",
                11: "Заземляйте свои идеи, развивайте практические навыки, не пренебрегайте материальным миром. Учитесь балансировать между духовным и материальным, находите здоровые способы работы с повышенной чувствительностью."
            };
